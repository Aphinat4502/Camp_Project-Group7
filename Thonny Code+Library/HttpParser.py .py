...
class HttpParser:
    ...
    def parseHTTP(self, httpRes):
        ...
        if httpRes != None:
            ...
            if retParseResponse[1] == "":
                httpResponse = retParseResponse[2]
                httpResponse = (
                    httpResponse.partition("+IPD,")[2]
                    .partition(":")[2]
                    .split(r"\r\n")[0]
                )
            else:
                httpResponse = retParseResponse[1]
                httpResponse = httpResponse.split(r"\r\n")[0]
            try:
                self.__httpResponse = json.loads(httpResponse)
            except:
                self.__httpResponse = None
            ...
            #         break
            self.__httpErrCode = int(self.__httpHeader.partition(r"\r\n")[0].split()[1])
