...
class NetworkHelper:
    ...
    def __init__(self, uartPort=0, baudRate=115200, txPin=(16), rxPin=(17)):
        ...
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("จง ปลาบ ปลื้ม คนเขียน libery Cr.Nontakorn Konkain")
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
        print("\r\n")
        """
    ...
    def connectWiFi(self, ssid, pwd, delay=2):
        ...
        # print(txData)
        retData = self._sendToESP8266(txData, delay=5)
        # print(".....")
        # print(retData)
        if retData != None:
            if "+CWJAP" in retData:
